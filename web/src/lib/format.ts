...
export const BOOK_NAMES: Record<string, string> = {
  ...
  fanatics: "Fanatics", polymarket: "Polymarket", lowvig: "LowVig", mybookieag: "MyBookie", espnbet: "ESPN BET", ballybet: "Bally Bet", betparx: "betPARX", hardrockbet: "Hard Rock", betus: "BetUS",
};
